...
import { transporter } from '../rendered/public/js/transporter.js';
...
const getProducts = async (req, res) => {
    try {
        ...
        const productsResult = await products.getProducts(filter, options);
...
const getIDProducts = async (req, res) => {
    ...
    try {
        const productsResult = await products.getIDProducts(pid);
...
const postProducts = async (req, res) => {
    ...
    if (existingProduct) {
        ...
        const productsResult = await products.postProducts(dbProduct);
...
const putProducts = async (req, res) => {
    ...
    if (existingProduct) {
        ...
        const productsResult = await products.putProducts(pid, dbProduct);
...
const deleteProducts = async (req, res) => {
    ...
    try {
        ...
        const productsResult = await products.deleteProducts(pid);
...
const mockingproducts = async (req, res) => {
    ...
    try {
        for (let i = 0; i < 50; i++) {
            ...
            await products.postProducts(product);
            productsCreated++;
        }
...
export { getProducts, getIDProducts, postProducts, putProducts, deleteProducts, mockingproducts, deleteMockingProducts };
